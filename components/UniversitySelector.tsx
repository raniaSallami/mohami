        ...
        <div className="flex items-center gap-2 flex-1">
          {selectedUniversity ? (
            <>
              ...
              <span className="text-right text-gray-900 dark:text-white truncate">{selectedUniversity.nameAr}</span>
              {!disabled && (
                <button
                  onClick={handleClear}
                  className="ml-auto p-1 hover:bg-gray-200 dark:hover:bg-slate-600 rounded transition"
                >
            ...
            <>
              ...
              <span className="text-right text-gray-500 dark:text-gray-400">اختر الجامعة</span>
            </>
          )}
        </div>
      </button>
                  ...
                  >
                    <div className="flex-1 text-right">
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        {university.city} • {university.type === 'public' ? 'حكومية' : 'خاصة'}
                      </p>
                    </div>
                    <Building2
