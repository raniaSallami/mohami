...
var An = (r, e, t, n) => {
  if (e && typeof e == "object" || typeof e == "function") for (let i of io(e)) !oo.call(r, i) && i !== t && Ie(r, i, { get: () => e[i], enumerable: !(n = no(e, i)) || n.enumerable });
  return r;
};
...
var Tn = I((it) => {
  ...
  function po(r, e, t) {
    for (var n, i = [], s = e; s < t; s += 3) n = (r[s] << 16 & 16711680) + (r[s + 1] << 8 & 65280) + (r[s + 2] & 255), i.push(fo(n));
    return i.join(
      ""
    );
  }
  a(po, "encodeChunk");
  function yo(r) {
    for (var e, t = r.length, n = t % 3, i = [], s = 16383, o = 0, u = t - n; o < u; o += s) i.push(po(r, o, o + s > u ? u : o + s));
...
var $n = I((Le) => {
  ...
  f.poolSize = 8192;
  function Mn(r, e, t) {
    if (typeof r == "string") return wo(r, e);
    if (ArrayBuffer.isView(r)) return bo(r);
    if (r == null) throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " + typeof r);
    if (ue(r, ArrayBuffer) || r && ue(r.buffer, ArrayBuffer) || typeof SharedArrayBuffer < "u" && (ue(r, SharedArrayBuffer) || r && ue(r.buffer, SharedArrayBuffer))) return Lt(
      r,
      e,
      t
    );
  ...
  function ko(r) {
    if (r = r.split("=")[0], r = r.trim().replace(Do, ""), r.length < 2) return "";
...
function $e(r) {
  let e = 1779033703, t = 3144134277, n = 1013904242, i = 2773480762, s = 1359893119, o = 2600822924, u = 528734635, c = 1541459225, h = 0, l = 0, y = [
    ...
    for (let R = 0, G = 0; R < 16; R++, G += 4) A[R] = B[G] << 24 | B[G + 1] << 16 | B[G + 2] << 8 | B[G + 3];
    for (let R = 16; R < 64; R++) {
    ...
    for (let w = 0; w < _.length; w++) B[l++] = _[w], l === 64 && W();
    h += _.length;
  }, "add"), de = a(() => {
...
var tt = I((zh, Di) => {
  ...
  a(Va, "escapeElement");
  function Mi(r) {
    for (var e = "{", t = 0; t < r.length; t++) t > 0 && (e = e + ","), r[t] === null || typeof r[t] > "u" ? e = e + "NULL" : Array.isArray(r[t]) ? e = e + Mi(r[t]) : r[t] instanceof d ? e += "\\\\x" + r[t].toString("hex") : e += Va(ft(r[t]));
    return e = e + "}", e;
  }
  a(Mi, "arrayString");
...
var Ni = I((Jh, qi) => {
  ...
  function nu(r) {
    ...
    if (t) {
      if (!ru(t)) throw new Error("SASL: SCRAM-SERVER-FIRST-MESSAGE: nonce must only contain printable characters");
...
var _s = I((qe) => {
  ...
  var D = zr(), uc = bs(), cc = ac((xs(), O(Ss))), rn = 1, hc = 4, vs = rn + hc, Es = d.allocUnsafe(
    ...
    constructor(e) {
      if (this.buffer = Es, this.bufferLength = 0, this.bufferOffset = 0, this.reader = new uc.BufferReader(), (e == null ? void 0 : e.mode) === "binary") throw new Error("Binary mode not supported yet");
...
function Zs(r, {
  ...
  if (l !== "postgres:" && l !== "postgresql:" || !y || !x || !A || !W) throw new Error("Database connection string format for `neon()` should be: postgresql://user:password@host.tld/dbname?option=value");
  function J(_, ...w) {
    let P, K;
    if (typeof _ == "string") P = _, K = w[1], w = w[0] ?? [];
    else {
      P = "";
      for (let j = 0; j < _.length; j++) P += _[j], j < w.length && (P += "$" + (j + 1));
    }
  ...
  a(J, "resolve"), J.transaction = async (_, w) => {
    if (typeof _ == "function" && (_ = _(J)), !Array.isArray(_)) throw new Error(Ks);
    _.forEach((k) => {
  ...
  async function de(_, w, P) {
    ...
    if (se.ok) {
      ...
      if (Array.isArray(_)) {
        let q = oe.results;
        if (!Array.isArray(q)) throw new Ce("Neon internal error: unexpected result format");
        return q.map((X, le) => {
...
var vn = class vn2 extends Ct.Client {
  ...
  async _handleAuthSASLContinue(t) {
    ...
    let o = Object.fromEntries(s.split(",").map((q) => {
      if (!/^.=/.test(q)) throw new Error("SASL: Invalid attribute pair entry");
